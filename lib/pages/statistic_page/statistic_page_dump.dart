...
class StatisticPageDump extends StatefulWidget {
  const StatisticPageDump({super.key});

  @override
  State<StatisticPageDump> createState() => _StatisticPageDumpState();
}
...
class _StatisticPageDumpState extends State<StatisticPageDump> {
